...
if(!empty($html_scr['subCategories'])){
	...
	if($ifcatname){
$pagestitle= "All Product In ".$CATEGORY_NAME." Category".$pagesname;
$metadesc= "Online Shopping ".$CATEGORY_NAME.", Browse Through Our Directory of ".$CATEGORY_NAME.$pagesname.", ".joincategory($morecats).", Worldwide Shipping!";
	}else{
$pagestitle= "Best Wholesale Product In This Years";
$metadesc= "Online Shopping for Cheap Automotive, Phones Accessories, Computers Electronics, Fashion, Beauty Health, Home Garden, Toys Sports, Weddings Events from China; Shopping on Aliexpress |the world's Online Marketing place.";
	}
...
<div class="m-footer">
    ...
    <div class="footer">
    	<div class="fluid">
        	<div class="foot-desc">
        	Search results are displayed by <a href="https://www.google.com/webmasters/sitemaps/ping?sitemap=https://<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank"><?php echo $_SERVER['HTTP_HOST'];?></a> is as a reference. By using <?php echo $_SERVER['HTTP_HOST'];?> services, you agree to comply with this regulation.
            </div>
