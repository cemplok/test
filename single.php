        ...
        <div class="m-gallery">
            <div class="gallery">
                <div class="galleryImg">
                    <img id="main-img" class="b-lazy b-loaded  i-amphtml-fill-content -amp-fill-content i-amphtml-replaced-content -amp-replaced-content" src="<?php echo $productimage;?>" layout="responsive" width="750" height="750"/>
                </div>
            </div>
                        <div class="clear"></div>
        </div>
...
<span class="g-seller" itemprop="author"><?php echo $resultdata['sellername'];?></span>
            ...
            <span class="font-ketoko" itemprop="ingredients" href="tel:+6281901008019"><?php echo $_GET['id'];?></span>
...
<img class="b-lazy i-amphtml-fill-content -amp-fill-content i-amphtml-replaced-content -amp-replaced-content" data-src="'.$pimgs.'" width="140" height="140"/>
                	</a>
                </div>
            	<div class="cItems">
                	<h4 class="m-title">
...
<div class="m-footer">
    ...
    <div class="footer">
    	<div class="fluid">
        	<div class="foot-desc">
        	Search results are displayed by <a href="https://www.google.com/webmasters/sitemaps/ping?sitemap=https://<?php echo $_SERVER['SERVER_NAME'];?>" target="_blank"><?php echo $_SERVER['SERVER_NAME'];?></a> is as a reference. By using <?php echo $_SERVER['SERVER_NAME'];?> services, you agree to comply with this regulation.
            </div>
